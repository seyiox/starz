<?php echo $this->Form->create('Client',array('role'=>'form','class'=>'form-horizontal'));?>
<!-- Navigation Bar -->
<nav class="navbar navbar-inverse" role="navigation">
	<p class="navbar-text">New Client</p>
	...
	<legend>General Information</legend>
  	...
  	<div class="form-group hidden-sm">
	    ...
	    <div class="col-sm-10"> <a href="#" data-toggle="modal" data-target="#myModal">
	    	<?php echo $this->Html->image('avatar-company.gif',array(
	    		'class'=>'img-thumbnail',
	    		'height'=>140,
				'id'=>'logo_preview',
	    		'width'=>140
